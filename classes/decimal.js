...
(function(globalScope) {
   ...
   */
    ...
    let Decimal; let inexact; let noConflict; let quadrant;
    let external = true;
   ...
   */
    P.cubeRoot = P.cbrt = function() {
        let e; let m; let n; let r; let rep; let s; let sd; let t; let t3; let t3plusx;
        const x = this;
        const Ctor = x.constructor;
   ...
   */
    P.hyperbolicCosine = P.cosh = function() {
        let k; let n; let pr; let rm; let len;
        let x = this;
        const Ctor = x.constructor;
   ...
   */
    P.inverseTangent = P.atan = function() {
        let i; let j; let k; let n; let px; let t; let r; let wpr; let x2;
        let x = this;
        const Ctor = x.constructor;
        const pr = Ctor.precision;
        const rm = Ctor.rounding;
   ...
   */
    P.logarithm = P.log = function(base) {
        let isBase10; let d; let denominator; let k; let inf; let num; let sd; let r;
        const arg = this;
   ...
   */
    P.minus = P.sub = function(y) {
        let d; let e; let i; let j; let k; let len; let pr; let rm; let xd; let xe; let xLTy; let yd;
        const x = this;
        const Ctor = x.constructor;
   ...
   */
    P.plus = P.add = function(y) {
        let carry; let d; let e; let i; let k; let len; let pr; let rm; let xd; let yd;
        const x = this;
        const Ctor = x.constructor;
   ...
   */
    P.squareRoot = P.sqrt = function() {
        let m; let n; let sd; let r; let rep; let t;
        const x = this;
        const d = x.d;
        let e = x.e;
        let s = x.s;
   ...
   */
    P.times = P.mul = function(y) {
        let carry; let e; let i; let k; let r; let rL; let t; let xdL; let ydL;
        const x = this;
        const Ctor = x.constructor;
        let xd = x.d;
   ...
   */
    P.toFraction = function(maxD) {
        let d; let d0; let d1; let d2; let e; let k; let n; let n0; let n1; let pr; let q; let r;
        const x = this;
        const xd = x.d;
        const Ctor = x.constructor;
   ...
   */
    P.toPower = P.pow = function(y) {
        let e; let k; let pr; let r; let rm; let s;
        let x = this;
        const Ctor = x.constructor;
   ...
   */
    var divide = (function() {
        ...
        return function(x, y, pr, rm, dp, base) {
            let cmp; let e; let i; let k; let logBase; let more; let prod; let prodL; let q; let qd; let rem; let remL; let rem0; let sd; let t; let xi; let xL; let yd0;
            let yL; let yz;
            const Ctor = x.constructor;
   ...
   */
    function finalise(x, sd, rm, isTruncated) {
        let digits; let i; let j; let k; let rd; let roundUp; let w; let xd; let xdi;
        const Ctor = x.constructor;
   ...
   */
    function naturalExponential(x, sd) {
        let denominator; let guard; let j; let pow; let sum; let t; let wpr;
        let rep = 0;
        let i = 0;
        let k = 0;
        const Ctor = x.constructor;
   ...
   */
    function naturalLogarithm(y, sd) {
        let c; let c0; let denominator; let e; let numerator; let rep; let sum; let t; let wpr; let x1; let x2;
        let n = 1;
        const guard = 10;
        let x = y;
        const xd = x.d;
   ...
   */
    function toStringBinary(x, baseOut, sd, rm) {
        let base; let e; let i; let k; let len; let roundUp; let str; let xd; let y;
        const Ctor = x.constructor;
